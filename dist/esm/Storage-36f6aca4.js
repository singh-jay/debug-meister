...
var Table = function(param) {
    ...
    var _useState = _sliced_to_array$3(useState(""), 2), editedIndex = _useState[0], setEditedIndex = _useState[1];
    var _useState1 = _sliced_to_array$3(useState(""), 2), editedValue = _useState1[0], setEditedValue = _useState1[1];
    var _useState2 = _sliced_to_array$3(useState(""), 2), showActionButtons = _useState2[0], setShowActionButtons = _useState2[1];
    var _useState3 = _sliced_to_array$3(useState(true), 2); _useState3[0]; _useState3[1];
    var _useState4 = _sliced_to_array$3(useState(false), 2), mounted = _useState4[0], setMounted = _useState4[1];
...
var Console = function() {
    var _useState = _sliced_to_array$2(useState([]), 2), logs = _useState[0], setLogs = _useState[1];
    var _useState1 = _sliced_to_array$2(useState(""), 2), filter = _useState1[0], setFilter = _useState1[1];
    var deferredFilterValue = useDeferredValue(filter);
    var _useState2 = _sliced_to_array$2(useState(false), 2), openSection = _useState2[0], setOpenSection = _useState2[1];
    useEffect(function() {
...
var Network = function() {
    var _useDebugContext = useDebugContext(), networkRequests = _useDebugContext.networkRequests, clearNetworkRequests = _useDebugContext.clearNetworkRequests;
