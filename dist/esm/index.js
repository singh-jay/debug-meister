'use client';
import React, { createContext, useContext, useState, useCallback, useEffect, Suspense, useSyncExternalStore, useRef, useDeferredValue, useMemo } from 'react';
...
var withNetworkLogger = function(WrappedComponent) {
    var NetworkLogger = function(props) {
        var _useState = _sliced_to_array$7(useState(new Map()), 2), requests = _useState[0], setRequests = _useState[1];
...
function DebugOverlay() {
    var _useState = _sliced_to_array$6(useState(false), 2), mounted = _useState[0], setMounted = _useState[1];
    var _useState1 = _sliced_to_array$6(useState(false), 2), openPopup = _useState1[0], setOpenPopup = _useState1[1];
    var _useState2 = _sliced_to_array$6(useState(null), 2), storageComponent = _useState2[0], setStorageComponent = _useState2[1];
    useEffect(function() {
        setMounted(true);
    }, []);
...
var NetworkProvider = function(param) {
    var children = param.children;
    var _useState = _sliced_to_array$5(useState(false), 2), mounted = _useState[0], setMounted = _useState[1];
    var _useState1 = _sliced_to_array$5(useState([]), 2), networkRequests = _useState1[0], setNetworkRequests = _useState1[1];
